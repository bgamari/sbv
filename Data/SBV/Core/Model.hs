...
retrieveUICode _  _  _  UIFree           = pure UINone
    ...
    where ka = kindOf (Proxy @a)
          result st = do isSMT <- inSMTMode st
                         case (isSMT, uiKind) of
                           ...
                           _                      -> do newUninterpreted st nm (SBVType [ka]) =<< retrieveUICode nm st ka uiKind
           ...
           where ka = kindOf (Proxy @a)
                 ...
                 result st = do isSMT <- inSMTMode st
                                case (isSMT, uiKind) of
                                  ...
                                  _                      -> do newUninterpreted st nm (SBVType [kb, ka]) =<< retrieveUICode nm st ka uiKind
                                                               sw0 <- sbvToSV st arg0
           ...
           where ka = kindOf (Proxy @a)
                 ...
                 result st = do isSMT <- inSMTMode st
                                case (isSMT, uiKind) of
                                  ...
                                  _                      -> do newUninterpreted st nm (SBVType [kc, kb, ka]) =<< retrieveUICode nm st ka uiKind
                                                               sw0 <- sbvToSV st arg0
                                                               sw1 <- sbvToSV st arg1
           ...
           where ka = kindOf (Proxy @a)
                 ...
                 result st = do isSMT <- inSMTMode st
                                case (isSMT, uiKind) of
                                  ...
                                  _                      -> do newUninterpreted st nm (SBVType [kd, kc, kb, ka]) =<< retrieveUICode nm st ka uiKind
                                                               sw0 <- sbvToSV st arg0
                                                               sw1 <- sbvToSV st arg1
                                                               sw2 <- sbvToSV st arg2
           ...
           where ka = kindOf (Proxy @a)
                 ...
                 result st = do isSMT <- inSMTMode st
                                case (isSMT, uiKind) of
                                  ...
                                  _                      -> do newUninterpreted st nm (SBVType [ke, kd, kc, kb, ka]) =<< retrieveUICode nm st ka uiKind
                                                               sw0 <- sbvToSV st arg0
                                                               sw1 <- sbvToSV st arg1
                                                               sw2 <- sbvToSV st arg2
                                                               sw3 <- sbvToSV st arg3
           ...
           where ka = kindOf (Proxy @a)
                 ...
                 result st = do isSMT <- inSMTMode st
                                case (isSMT, uiKind) of
                                  ...
                                  _                      -> do newUninterpreted st nm (SBVType [kf, ke, kd, kc, kb, ka]) =<< retrieveUICode nm st ka uiKind
                                                               sw0 <- sbvToSV st arg0
                                                               sw1 <- sbvToSV st arg1
                                                               sw2 <- sbvToSV st arg2
                                                               sw3 <- sbvToSV st arg3
           ...
           where ka = kindOf (Proxy @a)
                 ...
                 result st = do isSMT <- inSMTMode st
                                case (isSMT, uiKind) of
                                  ...
                                  _                      -> do newUninterpreted st nm (SBVType [kg, kf, ke, kd, kc, kb, ka]) =<< retrieveUICode nm st ka uiKind
                                                               sw0 <- sbvToSV st arg0
                                                               sw1 <- sbvToSV st arg1
                                                               sw2 <- sbvToSV st arg2
                                                               sw3 <- sbvToSV st arg3
           ...
           where ka = kindOf (Proxy @a)
                 ...
                 result st = do isSMT <- inSMTMode st
                                case (isSMT, uiKind) of
                                  ...
                                  _                      -> do newUninterpreted st nm (SBVType [kh, kg, kf, ke, kd, kc, kb, ka]) =<< retrieveUICode nm st ka uiKind
                                                               sw0 <- sbvToSV st arg0
                                                               sw1 <- sbvToSV st arg1
                                                               sw2 <- sbvToSV st arg2
                                                               sw3 <- sbvToSV st arg3
